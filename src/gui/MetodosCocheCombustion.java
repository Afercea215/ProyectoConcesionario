...
public class MetodosCocheCombustion {
	...
	public static DatosTabla creaDatosTablaOfiLibres(String cod) {
		return (new DatosTabla(nombreColumnas(), listaCochesElectricosTablaOfi(cod), anchoColumnas()));
	}
	...
	public static Object[][] listaCochesElectricosTablaOfi(String cod){
		ArrayList<CocheCombustion> lista = RepositorioCocheCombustion.arrayListCochesCombustionOfi(cod);
		int numColumnas = 16;
		int numFilas = lista.size();
		Object[][] listaTabla = new Object[numFilas][numColumnas];	
