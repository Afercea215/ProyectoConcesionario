...
public class MetodosCategoria {
	...
	public static JComboBox<Categoria> comboBoxColores (){
		JComboBox<Categoria> c = new JComboBox<Categoria>();
		
		for (Categoria a : RepositorioCategoria.arrayListCategorias() ){
			c.addItem(a);
		}
		return c;
	}
