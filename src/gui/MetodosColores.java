...
public class MetodosColores {
	
	
	public static JComboBox<Color> comboBoxColores (){
		JComboBox<Color> c = new JComboBox<Color>();
		
		for (Color a : RepositorioColor.arrayListColor() ){
			c.addItem(a);
		}
		return c;
	}
